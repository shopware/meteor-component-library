...
export const TestInheritance = Template.bind();
TestInheritance.storyName = 'Should remove and restore inheritance';
TestInheritance.args = {
  isInheritanceField: true,
  isInherited: false
};
TestInheritance.play = async ({ args }) => {
  const canvas = within(document.getElementById('root'));
