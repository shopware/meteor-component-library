          ...
          <thead>
            <tr>
              <template v-for="column in sortedColumns">
                ...
                >
                  <div class="sw-data-table__table-head-dragzone">
                    <div class="sw-data-table__table-head-dragzone-bar">
                  ...
                  <div class="sw-data-table__table-head-inner-wrapper">
                    ...
                    >
                      <sw-icon
                        name="solid-chevron-up-xxs"
                        class="sw-data-table__table-head-sort"
                        :class="{
                          'sw-data-table__table-head-sort--active': sortDirection === 'ASC',
                        }"
                      />
                      <sw-icon
                        ...
                        class="sw-data-table__table-head-sort"
                        :class="{
                          'sw-data-table__table-head-sort--active': sortDirection === 'DESC',
                        }"
                      />
                    </div>
                  </div>
                  ...
                  <!-- TODO: add translations & evaluate refactor to a separate component -->
                  <sw-popover
                    :title="column.label"
                  ...
                  >
                    ...
                    <template #popover-items__base="{ changeView, toggleFloatingUi }">
  ...
  setup(props, { emit }) {
    ...
    */
    ...
    return {
      ...
      console // TODO: remove, just for debugging
    };
  },
});
</script>
...
.sw-data-table {
  ...
  */
  .sw-data-table__table-head-sorting-icons {
    ...
    .sw-data-table__table-head-sort--active {
