...
describe("sw-pagination", () => {
  ...
  describe("should emit the correct events", () => {
    it("should emit the first page", async () => {
      ...
      await wrapper.find(".sw-segmented-control__action-id-pagination-first").trigger("click");
    ...
    it("should emit the previous page", async () => {
      ...
      await wrapper.find(".sw-segmented-control__action-id-pagination-previous").trigger("click");
    ...
    it("should emit the next page", async () => {
      ...
      await wrapper.find(".sw-segmented-control__action-id-pagination-next").trigger("click");
    ...
    it("should emit the last page", async () => {
      ...
      await wrapper.find(".sw-segmented-control__action-id-pagination-last").trigger("click");
