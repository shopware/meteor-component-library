...
import meta from './sw-tabs.stories';
...
export const  VisualTestRenderTabs = {
  name: 'Render tabs',
  args: {
    small: false,
    defaultItem: 'item2',
...
export const VisualTestRenderTabsVertical = {
...
export const VisualTestRenderTabsFullWidth = {
...
export const VisualTestRenderManyTabItems = {
...
export const VisualTestRenderTabsWithError = {
...
export const VisualTestRenderContextTabWithError = {
...
export const VisualTestRenderContextTabWithActiveItem = {
...
export const VisualTestRenderTabsWithPositiveBadge = {
...
export const VisualTestRenderTabsWithInfoBadge = {
...
export const VisualTestRenderTabsWithContextMenuBadge = {
