import{w as i,u as s}from"./index-912b65a3.js";import{e as n}from"./index-b9ac83fc.js";import{w as r}from"./test-helper-7c3608e5.js";import de from"./sw-select.stories-fc35c737.js";import"./_commonjsHelpers-de833af9.js";import"./index-356e4a49.js";import"./_baseIsEqual-75626070.js";import"./index-da07a199.js";import"./uniq-6b1dda04.js";import"./index-d38bc732.js";import"./sw-select-db38ef20.js";import"./vue.esm-bundler-651c6785.js";import"./sw-base-field-e219bc8c.js";import"./tooltip.directive-5026512a.js";import"./sw-icon-8cacf014.js";import"./iframe-6372cff1.js";import"../sb-preview/runtime.js";import"./_plugin-vue_export-helper-c27b6911.js";import"./index-76fb7be0.js";import"./isObject-32699ff3.js";import"./sw-loader-606e11d6.js";import"./sw-field-error-6589ed5a.js";import"./sw-popover-deprecated-4df170f7.js";import"./sw-color-badge-009d7ca8.js";import"./sw-button-8c07115b.js";import"./debounce-6f06ec9c.js";import"./_baseGetTag-22b9c805.js";import"./isObjectLike-e68f0fe0.js";import"./_MapCache-73175cc1.js";import"./isFunction-97e00978.js";const Pe={...de,title:"Interaction Tests/Form/sw-select"},c={name:"Should remove selections through selection list",args:{value:["a","b","d"],enableMultiSelection:!0},play:async({canvasElement:o,args:e})=>{const t=i(o);await s.click(t.getByRole("textbox"));const a=i(document.querySelector(".sw-popover-deprecated__wrapper"));await s.click(a.getByTestId("sw-select-option--a")),n(e.change).toHaveBeenCalledWith(["b","d"])}},p={name:"Should remove selection through result item",args:{value:["a","b","d"],enableMultiSelection:!0},play:async({canvasElement:o,args:e})=>{const t=i(o);await s.click(t.getAllByTestId("dismiss-label")[0]),n(e.change).toHaveBeenCalledWith(["b","d"])}},d={name:"Should clear selections",args:{value:["a","b","d"],enableMultiSelection:!0},play:async({canvasElement:o,args:e})=>{const t=i(o);await s.click(t.getByTestId("select-clear-button")),n(e.change).toHaveBeenCalledWith([])}},u={name:"Should single select",play:async({canvasElement:o,args:e})=>{const t=i(o);await s.type(t.getByRole("textbox"),"A"),await new Promise(l=>setTimeout(l,300));let a=i(document.querySelector(".sw-popover-deprecated__wrapper"));await r(()=>a.getByTestId("sw-select-option--a")),await s.click(a.getByTestId("sw-select-option--a")),n(e.itemAdd).toHaveBeenCalledWith({id:1,value:"a",label:"Option A"}),n(e.change).toHaveBeenCalledWith("a"),await new Promise(l=>setTimeout(l,300)),n(t.getByRole("textbox").value).toBe(""),await s.type(t.getByRole("textbox"),"F"),await new Promise(l=>setTimeout(l,300)),a=i(document.querySelector(".sw-popover-deprecated__wrapper")),await r(()=>a.getByTestId("sw-select-option--f")),await s.click(a.getByTestId("sw-select-option--f")),n(e.itemAdd).toHaveBeenCalledWith({id:6,value:"f",label:"Option F"}),n(e.change).toHaveBeenCalledWith("f"),n(t.getByRole("textbox").value).toBe(""),await s.type(t.getByRole("textbox"),"FF"),a=i(document.querySelector(".sw-popover-deprecated__wrapper")),await r(()=>a.getByTestId("sw-select-option--ff")),await s.click(a.getByTestId("sw-select-option--ff")),n(e.itemAdd).toHaveBeenCalledWith({id:7,value:"ff",label:"Option FF"}),n(e.change).toHaveBeenCalledWith("ff"),n(t.getByRole("textbox").value).toBe("")}},m={name:"Should multi select",args:{enableMultiSelection:!0},play:async({canvasElement:o,args:e})=>{const t=i(o);await s.click(t.getByRole("textbox"));const a=i(document.querySelector(".sw-popover-deprecated__wrapper"));await s.click(a.getByTestId("sw-select-option--a")),n(e.itemAdd).toHaveBeenCalledWith({id:1,value:"a",label:"Option A"}),n(e.change).toHaveBeenCalledWith(["a"]),await s.click(a.getByTestId("sw-select-option--b")),n(e.itemAdd).toHaveBeenCalledWith({id:2,value:"b",label:"Option B"}),n(e.change).toHaveBeenCalledWith(["a","b"]),await s.click(a.getByTestId("sw-select-option--c")),n(e.itemAdd).toHaveBeenCalledWith({id:3,value:"c",label:"Option C"}),n(e.change).toHaveBeenCalledWith(["a","b","c"]),await s.click(a.getByTestId("sw-select-option--e")),n(e.itemAdd).toHaveBeenCalledWith({id:5,value:"e",label:"Option E"}),n(e.change).toHaveBeenCalledWith(["a","b","c","e"]),await s.click(t.getByText("hidden")),n(t.getByRole("textbox").value).toBe("")}},v={name:"Should display prefix",args:{prefix:"prefix"},play:({canvasElement:o,args:e})=>{const t=i(o);n(t.getByText(e.prefix)).toBeDefined()}},h={name:"Should display suffix",args:{suffix:"suffix"},play:({canvasElement:o,args:e})=>{const t=i(o);n(t.getByText(e.suffix)).toBeDefined()}},g={name:"Should display hint",args:{hint:"hint"},play:async({canvasElement:o,args:e})=>{const t=i(o);await r(()=>{const a=document.querySelector(".sw-select-selection-list__item");return(a==null?void 0:a.textContent)==="Option B"}),n(t.getByText(e.hint)).toBeDefined()}},w={name:"Should disable",args:{disabled:!0,value:["a","b","d"],enableMultiSelection:!0},play:async({canvasElement:o})=>{const e=i(o);await s.click(e.getByRole("textbox"));const t=document.querySelector(".sw-popover-deprecated__wrapper");n(t).toBe(null)}},y={name:"Should display error",args:{error:{code:500,detail:"Error while saving!"}},play:async({canvasElement:o,args:e})=>{const t=i(o);await r(()=>{const a=document.querySelector(".sw-select-selection-list__item");return(a==null?void 0:a.textContent)==="Option B"}),n(t.getByText(e.error.detail)).toBeDefined()}},x={name:"Should highlight search term",args:{enableMultiSelection:!0},play:async({canvasElement:o})=>{const e=i(o);await s.type(e.getByRole("textbox"),"A"),await r(()=>document.getElementsByClassName("sw-select-result").length===1);const t=i(document.querySelector(".sw-popover-deprecated__wrapper"));n(t.getByText((a,l)=>{const b=S=>S.textContent==="Option A",ce=b(l),pe=Array.from((l==null?void 0:l.children)||[]).every(S=>!b(S));return ce&&pe})).toBeDefined()}},B={name:"Should trigger inheritance-remove event",args:{label:"Inherited",isInheritanceField:!0,isInherited:!0},play:async({canvasElement:o,args:e})=>{const t=i(o);await s.click(t.getByTestId("sw-inheritance-switch-icon")),n(e.inheritanceRemove).toHaveBeenCalledWith()}},T={name:"Should not show load more",play:async({canvasElement:o,args:e})=>{const t=i(o);await r(()=>document.querySelector('.sw-select-selection-list__item[title="Option B"]')),await s.type(t.getByRole("textbox"),"Option long text"),await r(()=>{const l=document.querySelector(".sw-highlight-text__highlight");return(l==null?void 0:l.textContent)==="Option long text"});const a=i(document.querySelector(".sw-popover-deprecated__wrapper"));await s.click(a.getByTestId("sw-select-option--Longer value text")),n(e.itemAdd).toHaveBeenCalledWith({id:8,label:"Option long text",value:"Longer value text"}),n(e.change).toHaveBeenCalledWith("Longer value text"),n(t.getByRole("textbox").value).toBe(""),n(t.queryByText("+12")).toBeNull()}};var f,E,H;c.parameters={...c.parameters,docs:{...(f=c.parameters)==null?void 0:f.docs,source:{originalSource:`{
...
}`,...(M=(A=u.parameters)==null?void 0:A.docs)==null?void 0:M.source}}};var L,q,V;m.parameters={...m.parameters,docs:{...(L=m.parameters)==null?void 0:L.docs,source:{originalSource:`{
...
}`,...(V=(q=m.parameters)==null?void 0:q.docs)==null?void 0:V.source}}};var F,D,U;v.parameters={...v.parameters,docs:{...(F=v.parameters)==null?void 0:F.docs,source:{originalSource:`{
...
}`,...(se=(oe=B.parameters)==null?void 0:oe.docs)==null?void 0:se.source}}};var ie,le,re;T.parameters={...T.parameters,docs:{...(ie=T.parameters)==null?void 0:ie.docs,source:{originalSource:`{
