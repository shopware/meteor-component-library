import{w as c,u as p,f as V}from"./index-912b65a3.js";import{e}from"./index-b9ac83fc.js";import fe from"./sw-colorpicker.stories-9315f27d.js";import"./_commonjsHelpers-de833af9.js";import"./index-356e4a49.js";import"./_baseIsEqual-75626070.js";import"./index-da07a199.js";import"./uniq-6b1dda04.js";import"./index-d38bc732.js";import"./vue.esm-bundler-f31f98e0.js";import"./sw-base-field-adb45841.js";import"./tooltip.directive-6ca7427e.js";import"./sw-icon-96b204b4.js";import"./iframe-e9565955.js";import"../sb-preview/runtime.js";import"./_plugin-vue_export-helper-c27b6911.js";import"./index-76fb7be0.js";import"./isObject-32699ff3.js";import"./sw-popover-deprecated-671376bc.js";import"./debounce-6f06ec9c.js";import"./_baseGetTag-22b9c805.js";import"./isObjectLike-e68f0fe0.js";const Je={...fe,title:"Interaction Tests/Form/sw-colorpicker"},d={name:"Render colorpicker"},m={name:"Open colorpicker",args:{modelValue:"rgba(72, 228, 37, 0.81)"},play:async({canvasElement:l})=>{const n=c(l).getByLabelText("colorpicker-toggle");await p.click(n);const o=c(document.getElementsByClassName("sw-popover-deprecated__wrapper")[0]),t=o.getByLabelText("colorpicker-color-range"),a=o.getByLabelText("colorpicker-alpha-range"),g=o.getByLabelText("hex-value"),i=o.getByLabelText("red-value"),s=o.getByLabelText("green-value"),u=o.getByLabelText("blue-value"),v=o.getByLabelText("alpha-value");e(t).toBeDefined(),e(t.value).toEqual("109"),e(a).toBeDefined(),e(a.value).toEqual("0.81"),e(g).toBeDefined(),e(g.value).toEqual("#48e425cf"),e(i).toBeDefined(),e(i.value).toEqual("72"),e(s).toBeDefined(),e(s.value).toEqual("228"),e(u).toBeDefined(),e(u.value).toEqual("37"),e(v).toBeDefined(),e(v.value).toEqual("81")}},h={name:"Change colorpicker color",args:{modelValue:"rgba(72, 228, 37, 0.81)"},play:async({canvasElement:l})=>{const n=c(l).getByLabelText("colorpicker-toggle");await p.click(n);const o=c(document.getElementsByClassName("sw-popover-deprecated__wrapper")[0]),t=o.getByLabelText("colorpicker-color-range"),a=o.getByLabelText("colorpicker-alpha-range"),g=o.getByLabelText("hex-value"),i=o.getByLabelText("red-value"),s=o.getByLabelText("green-value"),u=o.getByLabelText("blue-value"),v=o.getByLabelText("alpha-value");e(t).toBeDefined(),e(t.value).toEqual("109"),e(a).toBeDefined(),e(a.value).toEqual("0.81"),e(g).toBeDefined(),e(g.value).toEqual("#48e425cf"),e(i).toBeDefined(),e(i.value).toEqual("72"),e(s).toBeDefined(),e(s.value).toEqual("228"),e(u).toBeDefined(),e(u.value).toEqual("37"),e(v).toBeDefined(),e(v.value).toEqual("81"),V.input(t,{target:{value:300}}),V.input(a,{target:{value:1}}),e(t.value).toEqual("300"),e(a.value).toEqual("1"),await p.clear(i),await p.type(i,"240"),await p.clear(s),await p.type(s,"60"),await p.clear(u),await p.type(u,"150"),e(i.value).toEqual("240"),e(s.value).toEqual("60"),e(u.value).toEqual("150"),e(g.value).toEqual("#f03c96")}},x={name:"Change colorpicker label",args:{label:"Another label"}},E={name:"Change colorpicker output to HEX",args:{label:"Should output HEX",colorOutput:"hex"},play:async({canvasElement:l})=>{const r=c(l),n=r.getByLabelText("colorpicker-toggle");await p.click(n);const t=c(document.getElementsByClassName("sw-popover-deprecated__wrapper")[0]).getByLabelText("hex-value");e(t).toBeDefined(),e(t.value).toEqual("#0fcff5");const a=r.getByLabelText("colorpicker-color-value");e(a).toBeDefined(),e(a.value).toEqual("#0fcff5")}},y={name:"Change colorpicker output to HSL",args:{label:"Should output HSL",colorOutput:"hsl"},play:async({canvasElement:l})=>{const r=c(l),n=r.getByLabelText("colorpicker-toggle");await p.click(n);const t=c(document.getElementsByClassName("sw-popover-deprecated__wrapper")[0]).getByLabelText("hex-value");e(t).toBeDefined(),e(t.value).toEqual("#0fcff5");const a=r.getByLabelText("colorpicker-color-value");e(a).toBeDefined(),e(a.value).toEqual("hsl(190, 92%, 51%)")}},T={name:"Change colorpicker output to RGB",args:{label:"Should output RGB",colorOutput:"rgb"},play:async({canvasElement:l})=>{const r=c(l),n=r.getByLabelText("colorpicker-toggle");await p.click(n);const t=c(document.getElementsByClassName("sw-popover-deprecated__wrapper")[0]).getByLabelText("hex-value");e(t).toBeDefined(),e(t.value).toEqual("#0fcff5");const a=r.getByLabelText("colorpicker-color-value");e(a).toBeDefined(),e(a.value).toEqual("rgb(15, 207, 245)")}},b={name:"Change colorpicker output to HEX alpha",args:{modelValue:"#0fcff582",label:"Should output HEX",colorOutput:"hex"},play:async({canvasElement:l})=>{const r=c(l),n=r.getByLabelText("colorpicker-toggle");await p.click(n);const t=c(document.getElementsByClassName("sw-popover-deprecated__wrapper")[0]).getByLabelText("hex-value");e(t).toBeDefined(),e(t.value).toEqual("#0fcff582");const a=r.getByLabelText("colorpicker-color-value");e(a).toBeDefined(),e(a.value).toEqual("#0fcff582")}},k={name:"Change colorpicker output to HSL alpha",args:{modelValue:"#0fcff582",label:"Should output HSL",colorOutput:"hsl"},play:async({canvasElement:l})=>{const r=c(l),n=r.getByLabelText("colorpicker-toggle");await p.click(n);const t=c(document.getElementsByClassName("sw-popover-deprecated__wrapper")[0]).getByLabelText("hex-value");e(t).toBeDefined(),e(t.value).toEqual("#0fcff582");const a=r.getByLabelText("colorpicker-color-value");e(a).toBeDefined(),e(a.value).toEqual("hsla(190, 92%, 51%, 0.51)")}},B={name:"Change colorpicker output to RGB alpha",args:{label:"Should output RGB",modelValue:"#0fcff582",colorOutput:"rgb"},play:async({canvasElement:l})=>{const r=c(l),n=r.getByLabelText("colorpicker-toggle");await p.click(n);const t=c(document.getElementsByClassName("sw-popover-deprecated__wrapper")[0]).getByLabelText("hex-value");e(t).toBeDefined(),e(t.value).toEqual("#0fcff582");const a=r.getByLabelText("colorpicker-color-value");e(a).toBeDefined(),e(a.value).toEqual("rgba(15, 207, 245, 0.51)")}},L={name:"Render colorpicker without alpha",args:{label:"Should render without alpha value",alpha:!1},play:async({canvasElement:l})=>{const n=c(l).getByLabelText("colorpicker-toggle");await p.click(n);const o=c(document.getElementsByClassName("sw-popover-deprecated__wrapper")[0]),t=o.getByLabelText("hex-value");e(t).toBeDefined(),e(t.value).toEqual("#0fcff5");const a=o.queryByLabelText("alpha-value");e(a).toEqual(null)}},f={name:"Render disabled colorpicker",args:{label:"Should render disabled colorpicker",disabled:!0},play:async({canvasElement:l})=>{const n=c(l).getByLabelText("colorpicker-toggle");await p.click(n),e(document.getElementsByClassName("sw-popover-deprecated__wrapper").length).toEqual(0)}},w={name:"Clear colorpicker value",args:{label:"Should clear colorpicker value"},play:async({canvasElement:l})=>{const n=c(l).getByLabelText("colorpicker-color-value");await p.clear(n),e(n.value).toEqual("")}},I={name:"Render readonly colorpicker",args:{label:"Should render readonly colorpicker",readonly:!0},play:async({canvasElement:l})=>{const n=c(l).getByLabelText("colorpicker-color-value");e(n).toHaveAttribute("readonly"),await p.click(n)}},q={name:"Render colorpicker without color labels",args:{label:"Should render colorpicker without color labels",colorLabels:!1},play:async({canvasElement:l})=>{const n=c(l).getByLabelText("colorpicker-toggle");await p.click(n);const o=c(document.getElementsByClassName("sw-popover-deprecated__wrapper")[0]),t=o.getByLabelText("hex-value");e(t).toBeDefined(),e(t.value).toEqual("#0fcff5");const a=o.queryByText("HEX"),g=o.queryByText("R"),i=o.queryByText("G"),s=o.queryByText("B"),u=o.queryByText("Alpha");e(a).toEqual(null),e(g).toEqual(null),e(i).toEqual(null),e(s).toEqual(null),e(u).toEqual(null)}},C={name:"Render colorpicker with help text",args:{helpText:"Text for helping you"},play:async({canvasElement:l})=>{var a;const n=c(l).getByRole("tooltip");await p.hover(n),await(()=>new Promise((g,i)=>{const s=(u=0)=>{u>100&&i(),document.querySelector('[aria-label="currently-opened-tooltip"]')?g(!0):window.setTimeout(()=>s(u+1),25)};s()}))();const t=c((a=document.querySelector('[aria-label="currently-opened-tooltip"]'))==null?void 0:a.parentElement).getByLabelText("currently-opened-tooltip");e(t).not.toEqual(null),e(t.innerText).toEqual("Text for helping you")}};var H,D,R;d.parameters={...d.parameters,docs:{...(H=d.parameters)==null?void 0:H.docs,source:{originalSource:`{
...
}`,...(ee=($=b.parameters)==null?void 0:$.docs)==null?void 0:ee.source}}};var te,oe,ae;k.parameters={...k.parameters,docs:{...(te=k.parameters)==null?void 0:te.docs,source:{originalSource:`{
...
}`,...(ae=(oe=k.parameters)==null?void 0:oe.docs)==null?void 0:ae.source}}};var ne,le,re;B.parameters={...B.parameters,docs:{...(ne=B.parameters)==null?void 0:ne.docs,source:{originalSource:`{
